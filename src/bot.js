export class Bot {
  constructor(scene, pos = new THREE.Vector3()) {
    this.kind = 'bot';
    this.health = 100;
    this.dead = false;
    this.speed = 4;
    ...
    const mat = new THREE.MeshStandardMaterial({ color: 0xff5f5f });
  ...
  update(dt, player, world) {
    ...
    // recover color slowly
    this.mesh.material.color.lerp(new THREE.Color(0xff5f5f), 0.1);
    ...
    // obstacle avoidance (push away on intersect)
